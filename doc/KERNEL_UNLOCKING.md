...
| D3.1 (`vm_brk_shrink_two_phase`) | **live** (phase-split, seam-pending) | `D3_LIVE_SPLIT`. Stage 107; phase split Stage 112. `with_vm_user_spaces_split_mut`/`with_memory_split_mut` not yet called from this path (§1 Stage 112). |
