...
| **D4** `syscall/{debug,initramfs,recv_shared_v3,process,sched,cap,vm,ipc,helpers}.rs` | **PARTIAL** | Stage 102 + D4 steps 1–4 + Stage 145/146/149 | 9 modules landed (8 handler + 1 shared-helper); `syscall/dispatch.rs` and IPC-cross-boundary extraction pending (§5.1); see Stage 148/149 decomposition map |
...
Updated Stage 149 to reflect Stage 149 (helpers.rs) landing.
...
**Remaining in syscall.rs (Stage 149 audit, classified):**
