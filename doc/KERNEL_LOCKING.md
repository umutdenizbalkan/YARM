...
| runtime-required | **36** | the real retirement surface; U3 has retired eight post-lock drains — five on RISC-V and three on AArch64 (FutexWait/Yield switch-success restores onto the neutral exact-token resume core, FutexWait no-incoming idle onto the rank-1 scheduler seam) |
