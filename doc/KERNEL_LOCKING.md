...
| runtime-required | **37** | the real retirement surface; U3 has retired seven post-lock drains — five on RISC-V and two on AArch64 (the FutexWait and Yield switch-success restores, onto the neutral exact-token resume core) |
