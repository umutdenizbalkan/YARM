...
- For x86 QEMU bring-up, the first blocker is producing a direct-bootable kernel artifact (PVH-enabled ELF or `bzImage`); the generated initramfs BusyBox shell flow is treated as the second milestone once kernel entry is working.
