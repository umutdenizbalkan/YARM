...
use yarm::kernel::vfs_lite::{INITRAMFS_BUSYBOX_PATH_PTR, InitramfsService};
use yarm::kernel::vfs_proto::{VFS_OP_OPENAT, VFS_OP_READ, VFS_OP_WRITE, VfsV1Args};

use std::println;

fn main() {
    let mut svc = InitramfsService::new(8192);
