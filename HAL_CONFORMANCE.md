...
- A firmware-blob staging helper now validates required per-ISA controller keys and canonicalizes common alias fields before staging (`stage_irq_controller_description_from_firmware_blob`), reducing malformed handoff risk.
