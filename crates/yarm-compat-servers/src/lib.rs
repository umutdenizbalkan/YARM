...
pub mod yarm_compat_servers {
    pub use crate::{
        ...
        LINUX_COMPAT_SYSCALL_COUNT, LINUX_NR_BRK, LINUX_NR_CLOSE, LINUX_NR_CONNECT,
        LINUX_NR_DUP, LINUX_NR_EPOLL_CREATE1, LINUX_NR_EPOLL_CTL, LINUX_NR_EPOLL_PWAIT,
        LINUX_NR_EXIT, LINUX_NR_FCNTL, LINUX_NR_GETPID, LINUX_NR_GETPPID, LINUX_NR_IOCTL,
        LINUX_NR_MMAP, LINUX_NR_MPROTECT, LINUX_NR_MUNMAP, LINUX_NR_OPENAT, LINUX_NR_POLL,
        LINUX_NR_READ, LINUX_NR_SENDTO, LINUX_NR_SENDFILE, LINUX_NR_SOCKET, LINUX_NR_STATX,
        LINUX_NR_WRITE, POSIX_COMPAT_ABI_VERSION, POSIX_COMPAT_SYSCALL_COUNT, PosixErrno,
    };
