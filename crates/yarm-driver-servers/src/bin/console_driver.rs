...
yarm_server_runtime::install_freestanding_allocator!(
    256 * 1024,
    "console driver freestanding allocator OOM"
);
...
pub extern "C" fn yarm_user_entry() -> ! {
    yarm_user_rt::user_log!("CONSOLE_DRIVER_BIN_ENTRY_START");
    yarm_user_rt::user_log!("CONSOLE_DRIVER_BEFORE_RUN");
    run();
    unreachable!("console driver resident service loop returned")
}
