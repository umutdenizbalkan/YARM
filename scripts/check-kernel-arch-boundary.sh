...
check_absent '^const MAX_IRQ_LINES: usize = [0-9]+' src/kernel/bootstrap.rs
check_absent 'pub args: \[usize; 6\]' src/kernel/trapframe.rs
check_absent 'SYSCALL_ARG_TRANSFER_CAP: usize = 5' src/kernel/syscall.rs
check_absent 'VirtAddr\(0xFFFF_0000\)' src/kernel/bootstrap.rs
check_absent 'next_anon_phys: 0x1000_0000' src/kernel/bootstrap.rs
