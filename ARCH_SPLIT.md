...
- Hosted-dev boot now also supports `YARM_IRQ_FIRMWARE_BLOB`, which is canonicalized via selected-ISA topology discovery before IRQ controller configuration.
